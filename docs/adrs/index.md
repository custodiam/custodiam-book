...
!!! info "Más ADRs en camino"
    ...
    Próximas ADRs a publicar: ADR-004 (cliente HTTP Flutter), ADR-005 (sqflite), ADR-012 a ADR-018 (arquitectura interna del cliente Flutter — Riverpod, Clean estricto, Result&lt;T&gt;, EnvConfig, dev.log, SplashPage, Design System).
